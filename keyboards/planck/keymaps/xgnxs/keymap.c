...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, BACKLIT, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, WIN_TRM, KC_RSFT
),
...
[_NAV] = LAYOUT_planck_grid(
    _______, TSK_MGR, _______, KC_MYCM, _______, KC_F5,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______,
