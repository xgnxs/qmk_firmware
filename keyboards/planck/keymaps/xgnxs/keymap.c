...
[_NAV] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, KC_F5,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______,
    _______, _______, _______, KC_END,  KC_HOME, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Reset|MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, DEBUG,   MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______,  _______, _______, _______,
